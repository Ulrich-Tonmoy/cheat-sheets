...
- ## CSS
  ...
  2. [css-grid-cheat-sheet](https://alialaa.github.io/css-grid-cheat-sheet/)
  3. [grid.malven](https://grid.malven.co/) - [flexbox.malven](https://flexbox.malven.co/)
  4. [CSS Easing functions](https://easings.net/)
  5. [code-magic](https://code-magic.vercel.app/)
  6. [motion-ui](https://zurb.com/playground/motion-ui)
  7. [themeselection](https://bootstrap-cheatsheet.themeselection.com/)
  8. [hint](https://kushagra.dev/lab/hint)
  9. [webgradients](https://webgradients.com/)
  10. [enjoycss](https://enjoycss.com/)
  11. [fancy-border-radius](https://9elements.github.io/fancy-border-radius/)
  12. [neumorphism](https://neumorphism.io/#e0e0e0)
  13. [clippy](https://bennettfeely.com/clippy/)
  14. [easing-gradients](https://larsenwork.com/easing-gradients/)
  15. [shadows](https://shadows.brumm.af/)
  16. [cubic-bezier](https://cubic-bezier.com/#.17,.67,.83,.67)
  17. [cssgradient](https://cssgradient.io/)
  18. [css-separator-generator](https://wweb.dev/resources/css-separator-generator/)
  ...
  30. [css-glow-generator](https://cssbud.com/css-generator/css-glow-generator/)
  31. [clothoid](https://onotakehiko.dev/clothoid/)
  32. [glassmorphism-generator](https://hype4.academy/tools/glassmorphism-generator)
  33. [cssfilters](https://www.cssfilters.co/)
  34. [base64-image](https://www.base64-image.de/)
  35. [quantityqueries](https://quantityqueries.com/)
  36. [animate](https://keyframes.app/animate)
  37. [waitanimate](https://waitanimate.wstone.uk/)
  38. [transition](https://www.transition.style/)
  39. [heropatterns](https://heropatterns.com/)
  40. [haikei](https://app.haikei.app/)
  41. [pattern-generator](https://doodad.dev/pattern-generator/)
  42. [css-pattern](https://css-pattern.com/)
  43. [patternizer](https://patternizer.com/4rjn)
  44. [patternify](http://www.patternify.com/)
  45. [animated-css-background-generator](https://wweb.dev/resources/animated-css-background-generator/)
  46. [trianglify](https://trianglify.io/)
  47. [animatedbackgrounds](https://animatedbackgrounds.me/)
  48. [css-backgrounds](https://www.magicpattern.design/tools/css-backgrounds)
  49. [stylifycss](https://stylifycss.com/)
  50. [emojicursor](https://www.emojicursor.app/)
  51. [css-generators](https://css-generators.com/)
  52. [cssportal](https://www.cssportal.com/)
  53. [squircley](https://squircley.app/)
  54. [all-animation](https://all-animation.github.io/)
  55. [csshake](https://elrumordelaluz.github.io/csshake/)
  56. [Hover](https://ianlunn.github.io/Hover/)
  57. [infinite](https://tilomitra.github.io/infinite/)
  58. [Woah.css](https://www.joerezendes.com/projects/Woah.css/)
  59. [finisher](https://www.finisher.co/lab/header/)
  60. [css-tools](https://10015.io/css-tools)
  61. [hamburgers](https://jonsuh.com/hamburgers/)
  62. [cssbuttons](https://cssbuttons.app/)
...
4. [godot-zig](https://github.com/godot-zig/godot-zig)
5. [GDExtension example (gdext)](https://github.com/contextfreecode/gdext)
6. [Pixelorama](https://github.com/Orama-Interactive/Pixelorama)
7. [Godot-Orchestrator](https://github.com/Vahera/godot-orchestrator)
8. [godot-minimal-theme](https://github.com/passivestar/godot-minimal-theme)
9. [hoodie](https://github.com/GreenCrowDev/hoodie)
10. [material-maker](https://github.com/RodZill4/material-maker)
11. [TerraBrush](https://github.com/spimort/TerraBrush)
12. [Asset-Drawer](https://github.com/newjoker6/Asset-Drawer)
13. [GodotEzDialoguePlugin](https://github.com/real-ezTheDev/GodotEzDialoguePlugin)
14. [3D-Characters-Repository](https://github.com/gdquest-demos/3D-Characters-Repository)
15. [godot_heightmap_plugin](https://github.com/Zylann/godot_heightmap_plugin)
16. [ufbx](https://github.com/ufbx/ufbx)
17. [FBX2glTF](https://github.com/godotengine/FBX2glTF)
18. [Terrain3D](https://github.com/TokisanGames/Terrain3D)
19. [phantom-camera](https://github.com/ramokz/phantom-camera)
20. [Gaea](https://github.com/BenjaTK/Gaea)
21. [dialogic](https://github.com/coppolaemilio/dialogic)
22. [TODO_Manager](https://github.com/OrigamiDev-Pete/TODO_Manager)
23. [grider](https://github.com/alfredbaudisch/grider)
24. [godot-open-rpg](https://github.com/GDQuest/godot-open-rpg)
25. [unidot_importer](https://github.com/V-Sekai/unidot_importer)
26. [unitypackage_godot](https://github.com/barcoderdev/unitypackage_godot)
27. [godot4-demo-desert-light](https://github.com/RPicster/godot4-demo-desert-light)
28. [Godot-4-Overgrown-Subway-Demo](https://github.com/mikatomik/Godot-4-Overgrown-Subway-Demo)
29. [cyclopsLevelBuilder](https://github.com/blackears/cyclopsLevelBuilder)
30. [enu](https://github.com/dsrw/enu)
31. [godot-nim](https://github.com/pragmagic/godot-nim)
...
10. [ET](https://github.com/egametang/ET)
11. [MeshSync](https://github.com/unity3d-jp/MeshSync)
12. [Entitas](https://github.com/sschmid/Entitas)
13. [unity-frosted-glass](https://github.com/andydbc/unity-frosted-glass)
14. [FastScriptReload](https://github.com/handzlikchris/FastScriptReload)
15. [FancyScrollView](https://github.com/setchi/FancyScrollView)
16. [AICommand](https://github.com/keijiro/AICommand)
17. [AIShader](https://github.com/keijiro/AIShader)
18. [unity-tailwindcss](https://github.com/BennyKok/unity-tailwindcss)
19. [ThumbCreator](https://github.com/AndreaDev3D/ThumbCreator)
20. [Easy-Icon-Maker](https://github.com/Servalstar/Easy-Icon-Maker)
21. [games.noio.planter](https://github.com/noio/games.noio.planter)
22. [MegacityMultiplayer](https://github.com/Unity-Technologies/MegacityMultiplayer)
23. [Animation-Sequencer](https://github.com/brunomikoski/Animation-Sequencer)
24. [Unity-DeveloperConsole](https://github.com/DavidF-Dev/Unity-DeveloperConsole)
25. [ExtendingLWRP](https://github.com/johnsietsma/ExtendingLWRP)
26. [unity-stylized-water](https://github.com/danielshervheim/unity-stylized-water)
27. [DeBroglie](https://github.com/BorisTheBrave/DeBroglie)
28. [Unity3DCrossSectionShader](https://github.com/Dandarawy/Unity3DCrossSectionShader)
29. [Unity3d-BeastConsole](https://github.com/pointcache/Unity3d-BeastConsole)
30. [Unity-UI-Rounded-Corners](https://github.com/kirevdokimov/Unity-UI-Rounded-Corners)
31. [Moments](https://github.com/Chman/Moments)
32. [odin-serializer](https://github.com/TeamSirenix/odin-serializer)
...
1. [GameDev-Resources](https://github.com/Kavex/GameDev-Resources)
2. [awesome-gamedev](https://github.com/Calinou/awesome-gamedev)
3. [awesome-cpp](https://github.com/fffaraz/awesome-cpp)
4. [awesome-game-engine-dev](https://github.com/stevinz/awesome-game-engine-dev)
5. [awesome-haxe-gamedev](https://github.com/Dvergar/awesome-haxe-gamedev)
6. [Awesome-Repository](https://github.com/decentraland-scenes/Awesome-Repository)
7. [magictools](https://github.com/ellisonleao/magictools)
8. [html5-boilerplate](https://github.com/h5bp/html5-boilerplate)
9. [Front-End-Web-Development-Resources](https://github.com/RitikPatni/Front-End-Web-Development-Resources)
10. [Front-End-Checklist](https://github.com/thedaviddias/Front-End-Checklist)
11. [.NET-Backend-Developer-Roadmap](https://github.com/Elfocrash/.NET-Backend-Developer-Roadmap)
12. [front-end-interview-handbook](https://github.com/yangshun/front-end-interview-handbook)
...
15. [javascript-questions](https://github.com/lydiahallie/javascript-questions)
16. [css-protips](https://github.com/AllThingsSmitty/css-protips)
17. [nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)
18. [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
19. [30-Days-Of-JavaScript](https://github.com/Asabeneh/30-Days-Of-JavaScript)
20. [33-js-concepts](https://github.com/leonardomso/33-js-concepts)
21. [airbnb-javascript](https://github.com/airbnb/javascript)
22. [public-apis](https://github.com/public-apis/public-apis) - [public-apis](https://github.com/public-apis-dev/public-apis) - [public-api-lists](https://github.com/public-api-lists/public-api-lists)
23. [api-guidelines](https://github.com/microsoft/api-guidelines)
24. [freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
25. [realworld](https://github.com/gothinkster/realworld)
26. [coding-interview-university](https://github.com/jwasham/coding-interview-university)
27. [build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
28. [computer-science](https://github.com/ossu/computer-science)
29. [free-programming-books](https://github.com/EbookFoundation/free-programming-books)
30. [design-resources-for-developers](https://github.com/bradtraversy/design-resources-for-developers)
31. [project-based-learning](https://github.com/practical-tutorials/project-based-learning)
32. [awesome-cheatsheets](https://github.com/LeCoupa/awesome-cheatsheets)
33. [data-science](https://github.com/ossu/data-science)
