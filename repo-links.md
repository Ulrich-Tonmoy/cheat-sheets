...
4. IDE [JetBrains Freemium](https://www.jetbrains.com/products/) - [Visual Studio](https://visualstudio.microsoft.com/)
5. [VS Codium](https://github.com/VSCodium/vscodium)
6. [Helix](https://github.com/helix-editor/helix)
7. [Emacs](https://github.com/emacs-mirror/emacs) - [spacemacs](https://github.com/syl20bnr/spacemacs) - [doomemacs](https://github.com/doomemacs/doomemacs) - [Evil](https://github.com/emacs-evil/evil) - [Rust ❤️ Emacs](https://github.com/remacs/remacs)
8. [Lapce](https://github.com/lapce/lapce)
9. [Pulsar](https://github.com/pulsar-edit/pulsar)
