...
- [RectifyPad](https://github.com/Lixkote/RectifyPad) - [Files](https://github.com/files-community/files) - [File Pilot](https://filepilot.tech/) - [Superfile](https://github.com/yorukot/superfile) - [CopyParty](https://github.com/9001/copyparty) - [Dangerzone](https://github.com/freedomofpress/dangerzone)
...
6. [MetaGPTX](https://mgx.dev/)
7. [Firebase Studio](https://firebase.studio/) - [Stitch](https://stitch.withgoogle.com/)
8. [Replit](https://replit.com/)
9. [Dyad](https://github.com/dyad-sh/dyad)
10. [open-lovable](https://github.com/firecrawl/open-lovable)
11. [bolt.diy](https://github.com/stackblitz-labs/bolt.diy)
12. [IDE by Bind AI](https://www.getbind.co/)
13. [Aide](https://aide.dev/)
14. [Tempo Labs](https://www.tempolabs.ai/)
15. [rork](https://rork.app/) - [a0](https://a0.dev/) - [appacella](https://www.appacella.com/) - [makeway](https://makeway.app/)
16. [builder.io](https://www.builder.io/)
17. [Blackbox](https://www.blackbox.ai/)
18. [Softgen](https://softgen.ai/)
19. [Wrapifai](https://wrapifai.com/)
20. [Databutton](https://databutton.com/)
21. [webdraw](https://webdraw.com/)
22. [Colab](https://colab.research.google.com/)
